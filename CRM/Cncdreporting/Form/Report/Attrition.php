...
class CRM_Cncdreporting_Form_Report_Attrition extends CRM_Report_Form {
  ...
  private function getReportColumns() {
    ...
    $colTitles = [
      ...
      'month_0_num_cancelled' => 'SEPA annulés à M',
      'month_0_pct_cancelled' => '% SEPA annulés à M',
      'month_0_total_received' => 'Montant mensuel reçu à M',
      'month_1_num_active' => 'Nombre SEPA actif à M+1',
      'month_1_num_cancelled' => 'SEPA annulés à M+1',
      'month_1_pct_cancelled' => '% SEPA annulés à M+1',
      'month_1_total_received' => 'Montant mensuel reçu à M+1',
      'month_1_evolution_total_received' => 'Evolution Montant reçu à M+1',
      'month_2_num_active' => 'Nombre SEPA actif à M+2',
      'month_2_num_cancelled' => 'SEPA annulés à M+2',
      'month_2_pct_cancelled' => '% SEPA annulés à M+2',
      'month_2_total_received' => 'Montant mensuel reçu à M+2',
      'month_2_evolution_total_received' => 'Evolution Montant reçu à M+2',
      'month_2_cumul_total_received' => 'Cumul montant à M+2',
      'month_3_num_active' => 'Nombre SEPA actif à M+3',
      'month_3_num_cancelled' => 'SEPA annulés à M+3',
      'month_3_pct_cancelled' => '% SEPA annulés à M+3',
      'month_3_total_received' => 'Montant mensuel reçu à M+3',
      'month_3_evolution_total_received' => 'Evolution Montant reçu à M+3',
      'month_3_cumul_total_received' => 'Cumul montant à M+3',
      'month_6_num_active' => 'Nombre SEPA actif à M+6',
      'month_6_num_cancelled' => 'SEPA annulés à M+6',
      'month_6_pct_cancelled' => '% SEPA annulés à M+6',
      'month_6_total_received' => 'Montant mensuel reçu à M+6',
      'month_6_evolution_total_received' => 'Evolution Montant reçu à M+6',
      'month_6_cumul_total_received' => 'Cumul montant à M+6',
      'month_12_num_active' => 'Nombre SEPA actif à M+12',
      'month_12_num_cancelled' => 'SEPA annulés à M+12',
      'month_12_pct_cancelled' => '% SEPA annulés à M+12',
      'month_12_total_received' => 'Montant mensuel reçu à M+12',
      'month_12_evolution_total_received' => 'Evolution Montant reçu à M+12',
      'month_12_cumul_total_received' => 'Cumul montant à M+12',
      'month_24_num_active' => 'Nombre SEPA actif à M+24',
      'month_24_num_cancelled' => 'SEPA annulés à M+24',
      'month_24_pct_cancelled' => '% SEPA annulés à M+24',
  ...
  public function alterDisplay(&$rows) {
    ...
    $this->correctDecimalSeparator($rows);
  }
    ...
    foreach ($rows as $row) {
      foreach ($row as $k => $v) {
        switch ($k) {
          ...
          case 'civicrm_dummy_entity_month_3_num_cancelled':
          ...
          case 'civicrm_dummy_entity_month_24_cumul_total_received':
            ...
            break;
          case 'civicrm_dummy_entity_month_0_pct_cancelled':
          case 'civicrm_dummy_entity_month_1_pct_cancelled':
          case 'civicrm_dummy_entity_month_2_pct_cancelled':
          case 'civicrm_dummy_entity_month_3_pct_cancelled':
          ...
          case 'civicrm_dummy_entity_month_24_pct_cancelled':
            ...
            break;
          case 'civicrm_dummy_entity_month_1_evolution_total_received':
          case 'civicrm_dummy_entity_month_2_evolution_total_received':
          case 'civicrm_dummy_entity_month_3_evolution_total_received':
  ...
  private function correctDecimalSeparator(&$rows) {
    for ($i = 0; $i < count($rows); $i++) {
      foreach ($rows[$i] as $k => $v) {
        $rows[$i][$k] = str_replace('.', ',', $v);
      }
    }
  }
}
